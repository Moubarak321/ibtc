        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6">
              International Business and Tourisme Company
            </p>
            <p className="text-gray-300 mb-6">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="services/analyse-des-affaires" className="text-gray-300 hover:text-white transition-colors">Analyse des Affaires</a></li>
              <li><a href="services/btp" className="text-gray-300 hover:text-white transition-colors">BTP & Construction</a></li>
              <li><a href="services/tourisme" className="text-gray-300 hover:text-white transition-colors">Tourisme</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/qbout" className="text-gray-300 hover:text-white transition-colors">À propos</a></li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <MapPin className="h-10 w-7 text-blue-400" />
                <span className="text-gray-300">Cotonou, Zogbohoue</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                <Phone className="h-7 w-10 text-blue-400" />
                <div>
                  <div className="text-gray-300 ">+229 01 45 08 57 58</div>
                  <div className="text-gray-300 ">+229 01 62 41 21 43 </div>
                  <div className="text-gray-300 ">+33 751 567 086</div>
                </div>
              </div>
