...
const ModernCarousel = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      title: "BTP & Quincaillerie",
      subtitle: "Bâtir l'Avenir",
      description: "Des fondations solides aux finitions parfaites, nous vous fournissons les matiériaux de constructions les plus durables et résistants du marché.",
